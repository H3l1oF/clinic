...
try {
    $db = new database();
    $gg = $db->query("SELECT COUNT(*) FROM medico WHERE idEspecialidade = " . $_GET["idEspecialidade"]);
	...
	<div class="row no-gutters">
		<div class="col-lg-2 col-md-12 mx-auto">
			<div class="alert alert-danger shadow my-3" role="alert" style="border-radius: 3px">
				...
				<p style="font-size:18px" class="mb-0 font-weight-light text-center"><b class="mr-1">Erro! </b>Existe médicos a utilizar esta especialidade.</p>
